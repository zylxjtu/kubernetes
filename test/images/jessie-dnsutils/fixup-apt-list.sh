...
case ${DEB_ARCH} in
    s390x|arm64|ppc64el)
        ...
        echo "deb http://archive.debian.org/debian/ bookworm main contrib non-free" | tee /etc/apt/sources.list
        echo "deb-src http://archive.debian.org/debian/ bookworm main contrib non-free" | tee -a /etc/apt/sources.list
       ;;
esac
